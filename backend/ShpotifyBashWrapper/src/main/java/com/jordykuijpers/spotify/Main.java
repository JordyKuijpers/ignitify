...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			// IShpotifyBashWrapper spotify = new
			// ShpotifyBashWrapper("C:\\devprivate\\backend\\ShpotifyBash\\spotify_mock.cmd");
			// IShpotifyBashWrapper spotify = new
			// ShpotifyBashWrapper("/Volumes/DevOps/Ignitify/vibify/shpotify/shpotify/spotify");
			...
			// spotify.playResource(ResourceType.PLAYLIST, "High Performance,
			// concentration!");
			//
			// spotify.playResource(ResourceType.URI,
			// "spotify:track:7Dbg5O9nNWu6SWxDjJ9qoq");
			// spotify.playResource(ResourceType.URI, "---");
			//
			// spotify.next();
			// spotify.previous();
